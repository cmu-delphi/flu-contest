...
################################################################################
      'notifications': {
        'subject': 'New Data Available (Deadline: Tuesday 10AM)',
        'text': '''
Dear %s,
The CDC has released another week of flu surveillance data. A new round of flu forecasting is now underway, and we need your forecasts! Due to MLK day, this week we are asking you to please submit your forecasts by 10:00 AM (ET) this coming Tuesday.
...
<p>
  ...
  The CDC has released another week of flu surveillance data. A new round of flu forecasting is now underway, and we need your forecasts! Due to MLK day, this week we are asking you to please submit your forecasts by <b>10:00 AM (ET)</b> this coming Tuesday.
  Thank you so much for your support and cooperation!
</p><p>
  Accurate forecasting of flu’s spread in different regions is important for timely public alerts, education campaigns, vaccination campaigns, staffing decisions and resource allocations. For several years now, CDC has been supporting the development of flu forecasting technology via its annual “Predict the Flu” challenge.
