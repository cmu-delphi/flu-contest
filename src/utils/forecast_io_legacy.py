...
class Targets:
  """
  This class is a convenience copy of the canonical Targets class, which lives
  in fc_abstract.py. This version is deprecated in favor of that one and should
